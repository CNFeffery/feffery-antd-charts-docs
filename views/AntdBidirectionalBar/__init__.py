...
def render() -> Component:
    return doc_layout.render(
        component=fact.AntdBidirectionalBar,
        intro=intro.render(),
        demos=demos.render(component=fact.AntdBidirectionalBar),
        ...
        component_props=[
            ...
            },
            {
                ...
                'props': [
                    {'name': 'data'},
                    {'name': 'xField'},
                    {'name': 'yField', 'source': 'bidirectional-bar-yField'},
                    {'name': 'layout', 'source': 'bidirectional-bar-layout'},
                ],
            },
            {
                'type': 'prop',
