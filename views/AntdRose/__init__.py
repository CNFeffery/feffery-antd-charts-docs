...
def render() -> Component:
    return doc_layout.render(
        component=fact.AntdRose,
        intro=intro.render(),
        demos=demos.render(component=fact.AntdRose),
        ...
        component_props=[
            ...
            },
            {
                ...
                'props': [
                    ...
                    {'name': 'seriesField'},
                    {'name': 'isStack'},
                    {'name': 'isGroup', 'source': 'rose-isGroup'},
                    {'name': 'radius'},
                    {'name': 'innerRadius'},
                    {'name': 'startAngle', 'source': 'rose-startAngle'},
                    {'name': 'endAngle', 'source': 'rose-endAngle'},
                ],
            },
            {
                'type': 'prop',
