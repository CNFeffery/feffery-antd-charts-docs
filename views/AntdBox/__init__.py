...
def render() -> Component:
    return doc_layout.render(
        component=fact.AntdBox,
        intro=intro.render(),
        demos=demos.render(component=fact.AntdBox),
        ...
        component_props=[
            ...
            },
            {
                ...
                'props': [
                    {'name': 'data'},
                    {'name': 'xField'},
                    {'name': 'yField', 'source': 'box-yField'},
                    {'name': 'groupField', 'source': 'box-groupField'},
                    {'name': 'outliersField', 'source': 'box-outliersField'},
                ],
            },
            {
                'type': 'prop',
