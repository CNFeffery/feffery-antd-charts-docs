...
def render() -> Component:
    return doc_layout.render(
        component=fact.AntdWaterfall,
        intro=intro.render(),
        demos=demos.render(component=fact.AntdWaterfall),
        ...
        component_props=[
            ...
            },
            {
                ...
                'props': [
                    ...
                    {'name': 'xField'},
                    {'name': 'yField'},
                    {'name': 'labelMode', 'source': 'waterfall-labelMode'},
                    {'name': 'total', 'source': 'waterfall-total'},
                    {'name': 'leaderLine', 'source': 'waterfall-leaderLine'},
                    {'name': 'risingFill', 'source': 'waterfall-risingFill'},
                    {'name': 'fallingFill', 'source': 'waterfall-fallingFill'},
